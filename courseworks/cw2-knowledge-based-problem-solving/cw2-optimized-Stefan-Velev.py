...
PROLOG_FILE_NAME = "cw2-optimized-Stefan-Velev.pl"
PROLOG_QUERY = "all_optimal_paths([], PathListOptimal, _)."

pygame.display.set_caption("Knowledge-based Problem Solving: FOL (optimized)")
    ...
    while is_running:
        ...
        for e in pygame.event.get():
            ...
            if e.type == pygame.KEYDOWN and not algorithm_started:
                ...
                pygame.display.set_caption("Searching for an Optimal Solution with FOL ...")
                for row in grid:
                    for current_node in row:
