...
class MDP:
    ...
    def check_consistency(self):
        ...
        set(self.states) == self.get_states_from_transitions(self.transitions)

        # check that init is a valid state
        self.init in self.states

        # check reward for each state
        set(self.reward.keys()) == set(self.states)

        # check that all terminals are valid states
        all(t in self.states for t in self.terminals)
