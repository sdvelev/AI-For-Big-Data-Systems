from def_mdp_algorithms import *
from def_pomdp_algorithms import *

from def_grid_problem import *
...
def test_policy_iteration():
    ...
    policy_iteration(sequential_decision_environment_1) == {
        (0, 0): (0, 1), (0, 1): (0, 1), (0, 2): (1, 0),
        (1, 0): (1, 0), (1, 2): (1, 0), (2, 0): (0, 1),
        (2, 1): (0, 1), (2, 2): (1, 0), (3, 0): (-1, 0),
        (3, 1): None, (3, 2): None}

    policy_iteration(sequential_decision_environment_2) == {
...
def test_transition_model():
    ...
    mdp.T("a", "plan3") == [(0.2, 'a'), (0.5, 'b'), (0.3, 'c')]
    mdp.T("b", "plan2") == [(0.6, 'a'), (0.2, 'b'), (0.1, 'c'), (0.1, 'd')]
    mdp.T("c", "plan1") == [(0.3, 'a'), (0.5, 'b'), (0.1, 'c'), (0.1, 'd')]
...
def test_pomdp_value_iteration():
    ...
    -9.76 < sum_ < -9.70 or 246.5 < sum_ < 248.5 or 0 < sum_ < 1
...
def test_pomdp_value_iteration2():
    ...
    -77.31 < sum_ < -77.25 or 799 < sum_ < 800